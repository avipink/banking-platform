...
- Never expose internal domain models across the API boundary
- All API responses MUST use types from banking-contracts

## Specs Location
- Contract specs: specs/contracts/
- Feature specs:  specs/features/
- Templates:      team-ai-directives/templates/

## Kotlin Conventions (All Repos)
...
- Strict null safety — no !! operator in production code
